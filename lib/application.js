...
function (_EventEmitter) {
  ...
  function Application() {
    ...
    _this.context = Object.create(_context.default);
  ...
  _createClass(Application, [{
    ...
    value: function createContext(req, res) {
      ...
      var _request = ctx.request;
      var _response = ctx.response; // request
      ...
      _request.ctx = ctx;
      _request.response = res;
      _request.originalUrl = req.url; // response

      _response.app = this;
      _response.request = req;
      _response.response = res;
      _response.ctx = ctx;
      _request.request = req; // context
    ...
    value: function callback() {
      ...
      var fn = (0, _compose.default)(this.middleware);
