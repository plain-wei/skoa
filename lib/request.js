...
var _request = {
  ...
  get path() {
    return (0, _parseurl.default)(this.request).pathname;
  },

  set path(path) {
    var requestUrl = (0, _parseurl.default)(this.request);
  ...
  get querystring() {
    ...
    return (0, _parseurl.default)(this.request).query || '';
  },
  ...
  get charset() {
    try {
      var _contentType$parse = _contentType.default.parse(this.request),
  ...
  get accept() {
    this._accept = this._accept || (0, _accepts.default)(this.request);
    return this._accept;
  },
  ...
  is: function is(types) {
    if (!types) return (0, _typeIs.default)(this.request);
    ...
    return (0, _typeIs.default)(this.request, types);
  },
